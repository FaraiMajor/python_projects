...
responses = ['Okay', "I'm fine", "I'm doing great", "I'm ok",
             "I'm good", 'Good', 'Awesome', 'Great', 'Superb']
...
world = ('Africa', 'Antractica', 'Asia', 'Australia',
...
if year == 2022:
    print('You are very smart! It is the year of the world cup')
    print('Do enjoy it all!')
else:
